    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if self.training and self.sample_drop_ratio > 0.1:
            ...
            if self.use_residual_block:
                ...
                x[:, self.include_cls_token:, :] = x[:, self.include_cls_token:, :] + patch_embed.reshape(B, N-self.include_cls_token, C)
                # x[:, self.include_cls_token:, :] = patch_embed.reshape(B, N-self.include_cls_token, C)
