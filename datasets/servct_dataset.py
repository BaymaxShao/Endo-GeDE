...
class SERVCTDataset(data.Dataset):
    ...
    def __init__(self,
                 ...
                 num_scales,
                 is_train=False):
        super(SERVCTDataset, self).__init__()
        ...
        for i, rectified_file in enumerate(self.rectified_files):
            image01_paths = os.path.join(rectified_file, "Left_rectified", "*.png")
            ...
            for seq_image01_path in seq_image01_paths:
                ...
                seq_image02_path = os.path.join(rectified_file, "Right_rectified", filename)
                seq_depth01_path = os.path.join(rectified_file, "Reference_CT", "DepthL", filename)
                seq_depth02_path = os.path.join(rectified_file, "Reference_CT", "DepthR", filename)

                if os.path.exists(seq_image01_path) and os.path.exists(seq_image02_path) and os.path.exists(
                        seq_depth01_path) and os.path.exists(seq_depth02_path):
        ...
        print("Prepared SERV-CT dataset with %d sets of left & right images, left & right depths." % (len(self.scans)))
