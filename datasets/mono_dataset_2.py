...
class MonoDataset2(data.Dataset):
    ...
    def __init__(self,
                 ...
                 is_train=False,
                 img_ext='.png'):
        super(MonoDataset2, self).__init__()
        ...
        # self.load_depth = self.check_depth(is_train)
    ...
    def __getitem__(self, index):
        ...
        folder = os.path.join(folders[int(sequence)-1], 'Frames_{}{}'.format(syms[int(sequence)-1], keyframe))
